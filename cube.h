...
private:
    ...
    void setUpCubeVertexDataAndConfigureVertexAttribute()
    {
        ...
        float cube_vertices[] = {
            // positions      // normals         // texture
            // back
            -0.5f, -0.5f, -0.5f, 0.0f, 0.0f, -1.0f, .25, 0,
            0.5f, -0.5f, -0.5f, 0.0f, 0.0f, -1.0f, .5, 0,
            0.5f, 0.5f, -0.5f, 0.0f, 0.0f, -1.0f, .5, 1,
            -0.5f, 0.5f, -0.5f, 0.0f, 0.0f, -1.0f, .25, 1,

            // right
            0.5f, -0.5f, -0.5f, 1.0f, 0.0f, 0.0f, .75, 0,
            0.5f, 0.5f, -0.5f, 1.0f, 0.0f, 0.0f, .75, 1,
            0.5f, -0.5f, 0.5f, 1.0f, 0.0f, 0.0f, .5, 0,
            0.5f, 0.5f, 0.5f, 1.0f, 0.0f, 0.0f, .5, 1,

            // front
            -0.5f, -0.5f, 0.5f, 0.0f, 0.0f, 1.0f, TXmin, TYmin,
            0.5f, -0.5f, 0.5f, 0.0f, 0.0f, 1.0f, 0.25f, TYmin,
            0.5f, 0.5f, 0.5f, 0.0f, 0.0f, 1.0f, 0.25f, 0.25f,
            -0.5f, 0.5f, 0.5f, 0.0f, 0.0f, 1.0f, TXmin, 0.25f,
            ...
            -0.5f, 0.5f, -0.5f, 0.0f, 1.0f, 0.0f, .75, 1,
            -0.5f, 0.5f, 0.5f, 0.0f, 1.0f, 0.0f, .75, 0,
